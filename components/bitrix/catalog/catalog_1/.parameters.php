...
{
	$arLsmThemes['site'] = GetMessage('CPT_BC_TPL_THEME_SITE');
}

$arLsmThemes['blue'] = GetMessage('CPT_BC_TPL_THEME_BLUE');
$arLsmThemes['green'] = GetMessage('CPT_BC_TPL_THEME_GREEN');
$arLsmThemes['red'] = GetMessage('CPT_BC_TPL_THEME_RED');
$arLsmThemes['wood'] = GetMessage('CPT_BC_TPL_THEME_WOOD');
$arLsmThemes['yellow'] = GetMessage('CPT_BC_TPL_THEME_YELLOW');
$arLsmThemes['black'] = GetMessage('CP_BC_TPL_THEME_BLACK');
