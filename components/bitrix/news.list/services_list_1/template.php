...
<div class="section-body">
	<div class="row">
			...
			?>
			<div id="<?=$this->GetEditAreaId($arItem['ID']);?>" class="service-item item-<?=$n;?> wow fadeIn" data-wow-delay="0.1s">
				...
				<?}?>
					<div class="col-sm-8">
						<div class="list-content">
							...
							<div>
								<a href="<?=$arItem["DETAIL_PAGE_URL"]?>" class="btn btn-read-more"><?=GetMessage("READ_MORE");?></a>
							</div>
						</div>
					</div>	
					<div class="cls"></div>			
