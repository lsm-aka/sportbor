...
<?else:?>
	<div class="form-group">
		<input class="form-control" type="text" name="q" value="<?=$arResult["REQUEST"]["QUERY"]?>" size="50" />
	</div>
<?endif;?>
</li>
<li>
	<div class="form-group">
		<?if($arParams["SHOW_WHERE"]):?>
			&nbsp;<select id="search-select" name="where">
		...
		<?endif;?>
			...
			&nbsp;<input type="submit" class="btn btn-color btn-md search-btn" value="<?=GetMessage("SEARCH_GO")?>" />
...
<?elseif(count($arResult["SEARCH"])>0):?>
	...
	<?foreach($arResult["SEARCH"] as $arItem):?>
		<a class="search-elements-title" href="<?echo $arItem["URL"]?>"><?echo $arItem["TITLE_FORMATED"]?></a>
