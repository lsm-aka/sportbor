  ...
  <?=bitrix_sessid_post()?>
    ...
    <div class="form-group">  
      <select class="js-select2" name="userselect">
        ...
        <option value="<?=GetMessage("MFT_SELECT_2")?>"><?=GetMessage("MFT_SELECT_2")?></option>
        ...
        <option selected="selected" value="<?=GetMessage("MFT_SELECT_5")?>"><?=GetMessage("MFT_SELECT_5")?></option>
      </select>
    </div>
