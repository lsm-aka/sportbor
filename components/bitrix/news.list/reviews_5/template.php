...
<div class="row reviews-body">
	...
	<div class="reviews-slider-block review-img-block">

		<div id="owl-reviews-tpl5-a" class="owl-carousel owl-theme">
			<?foreach($arResult["ITEMS"] as $arItem){?>	
				<div class="review-img-item flex-box">	
					<?
					if( $arItem["PROPERTIES"]["AVATARS_PIC"]["VALUE"] > 0 ){
						$img_file = CFile::ResizeImageGet($arItem["PROPERTIES"]["AVATARS_PIC"]["VALUE"], array('width'=>120, 'height'=>120), BX_RESIZE_IMAGE_EXACT, true);
					?>													
	...
	<div class="reviews-slider-block review-item-block">	
		<div id="owl-reviews-tpl5-b" class="owl-carousel owl-theme">
			<?foreach($arResult["ITEMS"] as $arItem){?>
			<?	
			...
			<div class="review-item">
				<div class="content-wrap round-agle" id="<?=$this->GetEditAreaId($arItem['ID']);?>">
					<div class="review-wrap">	
						<div class="col-xs-12 review-content-wrap">
