	...
	$.fn.dsCountDown = function(givenOptions){
		...
		var init = function(){
			...
			if(! options.elemSelSeconds){			
				ds.prepend('<div class="ds-element ds-element-seconds">\<div class="ds-element-value ds-seconds">00</div>\<div class="ds-element-title">'+ options.titleSeconds +'</div>\</div>');
			...
			if(! options.elemSelMinutes){
				ds.prepend('<div class="ds-element ds-element-minutes">\<div class="ds-element-value ds-minutes">00</div>\<div class="ds-element-title">'+ options.titleMinutes +'</div>\</div>');
			...
			if(! options.elemSelHours){
				ds.prepend('<div class="ds-element ds-element-hours">\<div class="ds-element-value ds-hours">00</div>\<div class="ds-element-title">'+ options.titleHours +'</div>\</div>');
			...
			if(! options.elemSelDays){
				ds.prepend('<div class="ds-element ds-element-days">\<div class="ds-element-value ds-days">00</div>\<div class="ds-element-title">'+ options.titleDays +'</div>\</div>');
